...
class _AddingImagesScreenState extends State<AddingImagesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Añade imagenes del producto'),
      ),
      body: Column(
                        ...
                        child: InkWell(
                          onTap: listt.length < 6
                              ...
                              : () => showDialog(
                                    ...
                                    builder: (context) {
                                      return AlertDialog(
                                        content: Text(' Puedes añadir un máximo de seis imagenes'),
                                        actions: [
                                          ElevatedButton(
                                            child: Text('Aceptar'),
                                            onPressed: () =>
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Intenta subir más imagenes del producto, para que se pueda comprobar su estado, y tener más posibilidades de vender el artículo',
                              textAlign: TextAlign.start,
