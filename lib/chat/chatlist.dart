                              ...
                              child: Column(
                                children: <Widget>[
                                  ...
                                  Padding(
                                      ...
                                      child: CircleAvatar(
                                        radius: 9,
                                        child: Text(chatListSnapshot.data!.docs[0]['badgeCount'] == null ? '' : ((chatListSnapshot.data!.docs[0]['badgeCount'] != 0
                                          ? '${chatListSnapshot.data!.docs[0]['badgeCount']}'
                                          : '')),
                                        style: TextStyle(fontSize: 10),),
                                        backgroundColor: chatListSnapshot.data!.docs[0]['badgeCount'] == null ? Colors.transparent : (chatListSnapshot.data!.docs[0]['badgeCount'] != 0
                                          ? Colors.red[400]
                                          : Colors.transparent),
