  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      children: [
        const Expanded(
          flex: 3,
          child: Text( 'Confirmar publicación',
                    style: TextStyle(
              ...
              Expanded(
                    ...
                    child: TweenAnimationBuilder(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.stretch,
                        children: [
                          const Text('Publicando artículo....',
              ...
              Expanded(
                  ...
                  child: TweenAnimationBuilder(
                    ...
                    child: Column(
                      children: [
                        Text('¿Está seguro de publicar este artículo?',  style: TextStyle( fontWeight: FontWeight.w600, fontSize: 20), ),
                        const SizedBox( height: 10,),
